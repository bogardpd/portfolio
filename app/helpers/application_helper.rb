module ApplicationHelper
  ...
  def link_header(text, level, subtext=nil)
    ...
    return content_tag("h#{level}".to_sym, link_to(header, params.permit(:anchor, :gallery, :page, :version).merge(anchor: anchorize(text)), class: "link-header"), id: anchorize(text))
  end
