class StaticPagesController < ApplicationController
  ...
  def terminal_silhouettes
    ...
    @terminals["COS"] = "Colorado Springs"
    ...
    @terminals["ITO"] = "Hilo"
    @terminals["JFK"] = "New York (John F. Kennedy)"
